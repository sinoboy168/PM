...
# 内部平台列表
######################################
class CompanyPlatformListView(View):
...
# 运维平台列表
######################################
class OpsPlatformListView(View):
    def get(self, request):
        # 页面选择
        web_chose_left_1 = 'platform'
...
# 编辑平台用户列表
######################################
class EditPlatformUserView(View):
...
# 其它平台列表
######################################
class OtherPlatformListView(View):
    def get(self, request):
        # 页面选择
        web_chose_left_1 = 'platform'
...
# 添加其它平台
######################################
class AddOtherPlatformView(View):
    def post(self, request):
        try:
