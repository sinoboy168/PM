...
class HostListView(View):
    def get(self, request):
        if request.user.role > 1:
            ...
            # if idc != 0:
            #     machine_records = machine_records.filter(idc_id=idc)
...
class MachineMoveInView(View):
    def get(self, request):
        if request.user.role > 1:
            ...
            # 左侧菜单页面选择
            web_chose_left_1 = 'host_management'#一级菜单点亮
    ...
    def post(self, request):
        if request.user.role > 1:
            #request_form = MachineMoveInForm(request.POST)
               ...
               # obj=request_form.cleaned_data#数据库类赋值
                ...
                op_record.save()
                return redirect('/host/management/list')
...
class AddAreaView(View):
    ...
    def post(self, request):
        if request.user.role > 1:
            ...
            op_record.save()
            return redirect('/host/management/machine_move_in')
...
# 添加数据库记录
######################################
class AddDatabaseInfoView(View):
    def post(self, request):
        if request.user.role > 1:
...
# 修改数据库记录
######################################
class EditDatabaseInfoView(View):
    def post(self, request):
        if request.user.role > 1:
...
# 删除数据库记录
######################################
class DeleteDatabaseInfoView(View):
    def post(self, request):
        if request.user.role > 1:
            db_info = DatabaseInfo.objects.get(id=int(request.POST.get('db_id')))
            db_info.status = 0
...
# 删除数据库库
######################################
class DeleteDatabaseDBView(View):
    def post(self, request):
        if request.user.role > 1:
            db_info = DatabaseDBInfo.objects.get(id=int(request.POST.get('db_id')))
            db_info.update_user = request.user
...
# 添加数据库用户
######################################
class AddDatabaseUserView(View):
    def post(self, request):
        if request.user.role > 1:
            # 判断用户
...
# 编辑数据库用户
######################################
class EditDatabaseUserView(View):
    def post(self, request):
        if request.user.role > 1:
            # 判断用户
...
# 删除数据库用户
######################################
class DeleteDatabaseUserView(View):
    def post(self, request):
        if request.user.role > 1:
            # 判断用户
            db_user = DatabaseUserInfo.objects.get(id=int(request.POST.get('db_user_id')))
...
# 编辑系统服务
######################################
class EditHostServiceView(View):
    def post(self, request):
        if request.user.role > 1:
...
# 删除服务
######################################
class DeleteHostServiceView(View):
    def post(self, request):
        try:
...
# 网络设备列表
######################################
class NetworkDviceListView(View):
    def get(self, request):
        if request.user.role > 1:
            # 页面选择
            web_chose_left_1 = 'host_management'
...
# 添加网络设备
######################################
class AddNetworkDviceView(View):
    def post(self, request):
        if request.user.role > 1:
            name = request.POST.get('name')
...
# 编辑网络设备
######################################
class EditNetworkDviceView(View):
    def post(self, request):
        if request.user.role > 1:
...
# 删除设备
######################################
class DeleteNetworkDviceView(View):
    def post(self, request):
        if request.user.role > 1:
            net_dvice = NetworkDviceInfo.objects.get(id=int(request.POST.get('dv_id')))
            net_dvice.status = 0
...
# 删除映射
######################################
class DeletePortToPortView(View):
    def post(self, request):
        if request.user.role > 1:
            port_info = PortToPortInfo.objects.get(id=int(request.POST.get('p_id')))
            port_info.update_user = request.user
...
# 删除域名
######################################
class DeleteDomainNameView(View):
    def post(self, request):
        if request.user.role > 1:
            domain_info = DomainNameInfo.objects.get(id=int(request.POST.get('do_id')))
            domain_info.update_user = request.user
...
# 域名解析列表
######################################
class DomainNameResolveListView(View):
    def get(self, request):
        if request.user.role > 1:
            # 页面选择
            web_chose_left_1 = 'port_domain'
...
# 添加域名解析
######################################
class AddDomainNameResolveView(View):
    def post(self, request):
        if request.user.role > 1:
            name = request.POST.get('name')
...
# 修改域名解析
######################################
class EditDomainNameResolveView(View):
    def post(self, request):
        if request.user.role > 1:
...
# 删除域名解析
######################################
class DeleteDomainNameResolveView(View):
    def post(self, request):
        if request.user.role > 1:
            domain_info = DomainNameResolveInfo.objects.get(id=int(request.POST.get('do_id')))
            domain_info.update_user = request.user
