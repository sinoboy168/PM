...
urlpatterns = [
    # 设备列表
    path('list', HostListView.as_view(), name='machine_list'),
    ...
    # 设备入库-添加
    path('machine_move_in', MachineMoveInView.as_view(), name='machine_move_in'),
    path('add_area', AddAreaView.as_view(), name='add_area'),
